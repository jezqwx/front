    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <TouchableOpacity
            style={[styles.btn, (!form.email || !form.password || errors.email !== '') ? styles.btnDisabled : null]}
...
const styles = StyleSheet.create({
  ...
  input: {
    height: 55, backgroundColor: '#f5f5f5', borderRadius: 12, borderWidth: 1,
    borderColor: '#e0e0e0', paddingHorizontal: 15, fontSize: 16, color: '#333'
  },
  inputError: { borderColor: '#dc3545', backgroundColor: '#fff8f8' },
  errorText: { color: '#dc3545', fontSize: 12, marginTop: 5 },
  btn: {
    backgroundColor: '#0066cc', height: 55, borderRadius: 12,
    justifyContent: 'center', alignItems: 'center', marginTop: 20,
    shadowColor: '#0066cc', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3,
    shadowRadius: 5
  },
